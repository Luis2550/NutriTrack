...
<div class="container">
        <nav class="sidebar">
            <ul>
                ...
                <li><a href="http://localhost/Nutritrack2/index.php?c=Usuarios&a=verUsuarios"><i class="fa-solid fa-hospital-user"></i> Pacientes</a></li>
                <li><a href="http://localhost/Nutritrack2/index.php?c=historialSuscripcion&a=verHistorialSuscripcion"><i class="fa-solid fa-book"></i> Planes</a></li>
