...
<div class="container">
        <nav class="sidebar">
            <ul>
                ...
                <li><a href="#"><i class="fas fa-running"></i> Actividades</a></li>
                <li><a href="http://localhost/nutritrack/index.php?c=Citas&a=nuevoCitas"><i class="far fa-calendar-alt"></i> Agendar Cita</a></li>


                <li><a href="http://localhost/nutritrack/index.php?c=Citas&a=ver_citas_paciente&ci_paciente=<?= $_SESSION['usuario']['ci_usuario'] ?>"><i class="far fa-calendar-alt"></i> Ver citas</a></li>
