...
<form id="nuevo" name="nuevo" method="POST" action="index.php?c=actividad&a=actualizarActividad" autocomplete="off">
    ...
    <input type="text" id="ci_paciente" name="ci_paciente" required value="<?php echo $data["actividad"]["ci_paciente"]?>">
    ...
    <input type="date" id="fecha" name="fecha" required value="<?php echo $data["actividad"]["fecha"]?>">
