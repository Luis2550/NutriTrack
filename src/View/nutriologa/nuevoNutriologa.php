...
<body>
  ...
  <form id="nuevo" name="nuevo" method="POST" action="index.php?c=nutriologa&a=guardarMutriologa" autocomplete="off">
    ...
    <input type="text" id="cantidad_cupos" name="cantidad_cupos" required>
