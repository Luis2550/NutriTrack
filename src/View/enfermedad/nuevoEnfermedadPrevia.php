...
<body>
  ...
  <form id="nuevo" name="nuevo" method="POST" action="index.php?c=EnfermedadPrevia&a=guardarEnfermedadPrevia" autocomplete="off">
    <h2>Registro<?php echo $data['titulo'];?></h2>

    <label for="id_enfermedad_previa">ID Historial Clinico:</label>
    ...
    <input type="numb" id="enfermedad_previa" name="enfermedad_previa" required>

    <label for="descripcion">Descripcion de Enfermedad:</label>
    <input type="numb" id="descripcion" name="descripcion" required>
